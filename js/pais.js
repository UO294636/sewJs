...
class Pais{
    ...
    meteorologiaDeLaSalida(){
        ...
        $.ajax({
            ...
            success: function(datos){
                ...
                listaDias.each(function() {
                    ...
                    if(fechaHora[1] === "12:00:00") {
                        ...
                        imagen.setAttribute('src', "http://openweathermap.org/img/w/" + weatherIcon + ".png");
            ...
            error: function() {
                $("h3").html("¡Tenemos problemas! No puedo obtener los datos XML de <a href='http://openweathermap.org'>OpenWeatherMap</a>"); 
            }
        });
    }
